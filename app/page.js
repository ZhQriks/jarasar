...
export default function Home() {
  const blocks = [
    ...
    },
    {
      title: "Interests",
      description:
        "Software engineering, Clash Royale, Reverse Engineering, Horses",
    },
    {
      title: "Email",
  ...
  return (
    <main>
      <Hero />
      {/* <p className=" font-mono text-xl text-center mt-10">Jarasar Daulet</p> */}
      {/* <a
        className="text-center text-sm underline mt-1"
      ...
      <div className="mt-20 mb-32 flex flex-col text-center lg:w-full lg:mb-0 lg:text-left md:px-10">
        {blocks.map(({ title, description }) => (
          <div
            ...
            <p className={`ml-2 text-left text-md opacity-50`}>{description}</p>
          </div>
        ))}
      </div> */}
    </main>
